...
SECRET_KEY = 'django-insecure-^mllcrrnp1_u$mvs^ly#wjdis(dc2e=gh07*dq@w^j=3rx(ac2'
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'Your mail'  # Your email address
EMAIL_HOST_PASSWORD = 'mail Password'  # Your email password
